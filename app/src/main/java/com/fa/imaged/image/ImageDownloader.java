       ...
       public void downloadImagesToSdCard(String downloadUrl,String imageName)
        {
            try
            {
                ...
                File myDir = new File(sdCard+"/Pictures/Imaged/");
   		...
   		protected void onPostExecute(Boolean result) {
   			pd.dismiss();
     	   Toast.makeText(mContext, mContext.getResources().getString(R.string.download_success), Toast.LENGTH_SHORT);
        }
}
