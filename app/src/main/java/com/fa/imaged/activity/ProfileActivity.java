...
public class ProfileActivity extends BaseActivity {
        ...
        super.onCreate(savedInstanceState);
	        ...
	        if(savedInstanceState == null) {
                ...
                adapter = new ProfileImagesAdapter(
                        ...
                        App.getContext().getResources().getString(R.string.loadingbio),
                        App.getContext().getResources().getString(R.string.pleasewait));
	...
	public static void updateProfile(){
		...
		if(isMine){
		data.outgoing_status = App.getContext().getResources().getString(R.string.edit_profile_caps);
		}
        adapter = new ProfileImagesAdapter( 
        		a, 
        		profileImageGrid,
