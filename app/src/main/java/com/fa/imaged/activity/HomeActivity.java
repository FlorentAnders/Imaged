package com.fa.imaged.activity;
...
import com.fa.imaged.adapters.DrawerAdapter;
import com.fa.imaged.adapters.DrawerAdapter.ClickListener;
import com.fa.imaged.fragment.FeedFragment2;
import com.fa.imaged.fragment.SearchFragment;
import com.fa.imaged.nav.NavItems;
...
public class HomeActivity extends BaseActivity implements ClickListener {
    ...
    public static String[] themePrimaryAccentColors;
...
@Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments = new String[]{
                "com.fa.imaged.fragment.FeedFragment2",
        		"com.fa.imaged.fragment.PopularFragment",
        		"com.fa.imaged.fragment.NearbyFragment",
        		"com.fa.imaged.fragment.LikedPhotosFragment",
        		"com.fa.imaged.fragment.SettingsFragment",
        		"com.fa.imaged.fragment.AboutFragment",
        		"com.fa.imaged.fragment.LogoutFragment"};
        ...
        themePrimaryAccentColors = getResources().getStringArray(R.array.themeColorsPrimaryAccent);
        ...
        /*if (Build.VERSION.SDK_INT >= 21) {
            getWindow().setNavigationBarColor(Color.parseColor(themePrimaryDarkColors[selectedThemeInt]));
        }*/
	...
	*/
    ...
    FragmentTransaction tx = getFragmentManager().beginTransaction().setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
    tx.replace(R.id.fragment_container,Fragment.instantiate(HomeActivity.this, "com.fa.imaged.fragment.ErrorFragment"));
    tx.commit();
    }
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
	    ...
	    case FeedFragment2.RESULT_GALLERY :
	        if (data != null) {
	            ...
	            share.putExtra(Intent.EXTRA_TEXT, "Uploaded via Imaged");
