...
import com.fa.imaged.adapters.ProfileImagesAdapter;
import com.fa.imaged.data.User;
...
public class ProfileFragment extends Fragment {
	...
	public static FancyButton followControlBtn;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        	...
        	followControlBtn = (FancyButton) header.findViewById(R.id.profile_btn);
	       ...
	       if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
	        ...
	        if(isMine || extras.getString("profile_uname") == mApp.getUserName()){
	        	followControlBtn.setText(getActivity().getResources().getString(R.string.edit_profile_caps));
        	...
        	follower_container.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					i.putExtra("title", App.getContext().getString(R.string.followers_caps) + "(" + follower + ")");
					startActivity(i);
        	...
        	following_container.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					i.putExtra("user_id", userid);
					i.putExtra("title", App.getContext().getString(R.string.following_caps) + "(" + following + ")");
					startActivity(i);
