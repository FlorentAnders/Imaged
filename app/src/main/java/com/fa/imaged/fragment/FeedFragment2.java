...
import com.fa.imaged.utils.ApplicationData;
import com.fa.imaged.activity.BaseActivity;
import com.fa.imaged.activity.HomeActivity;
import com.fa.imaged.R;
import com.fa.imaged.utils.Utils;
import com.fa.imaged.adapters.RecyclerAdapter;
import com.fa.imaged.adapters.RecyclerAdapterV2;
import com.fa.imaged.posts.Comment;
import com.fa.imaged.posts.InstagramImage;
...
public class FeedFragment2 extends Fragment {
    ...
    public static void updateFab(int i){
        selectedThemeInt = i;
        FloatingActionButton mFabActionA = (FloatingActionButton) rootView.findViewById(R.id.action_a);
        mFabActionA.setColorNormal(Color.parseColor(themePrimaryColors[selectedThemeInt]));
        mFabActionA.setColorPressed(Color.parseColor(themePrimaryDarkColors[selectedThemeInt]));
        FloatingActionButton mFabActionB = (FloatingActionButton) rootView.findViewById(R.id.action_b);
        mFabActionB.setColorNormal(Color.parseColor(themePrimaryColors[selectedThemeInt]));
        mFabActionB.setColorPressed(Color.parseColor(themePrimaryDarkColors[selectedThemeInt]));
        FloatingActionsMenu mFabMenu = (FloatingActionsMenu) rootView.findViewById(R.id.multiple_actions);
        //mFabMenu.setBackgroundColor(Color.parseColor(themePrimaryColors[selectedThemeInt]));
        //mFabMenu.setColorPressed(Color.parseColor(themePrimaryDarkColors[selectedThemeInt]));
    }
